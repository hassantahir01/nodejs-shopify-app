...
var RedisStore = /** @class */ (function () {
    function RedisStore() {
        ...
        */
        this.storeCallback = function (session) { return __awaiter(_this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.setAsync(session.id, JSON.stringify(session))];
                    case 1: 
        ...
        */
        this.loadCallback = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var reply, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.getAsync(id)];
                    case 1:
                        reply = _a.sent();
                        if (reply) {
                            return [2 /*return*/, JSON.parse(reply)];
                        }
                        else {
        ...
        /*
          ...
          Otherwise, return false
        */
        this.deleteCallback = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.delAsync(id)];
                    case 1: 
        ...
        this.client = redis_1.default.createClient({
            host: 'redis-16143.c256.us-east-1-2.ec2.cloud.redislabs.com:16143',
            port: 6379,
            password: 'Admin123!'
        });
